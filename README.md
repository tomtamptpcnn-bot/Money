...
ราคาที่ดึงคือราคาขายทองคำแท่งจากสมาคมค้าทองคำ โดยนับเป็นราคาต่อ 1 บาททองคำ หาก API สมาคมค้าทองคำใช้ไม่ได้ แอพจะลองอ่านหน้า classic ของสมาคมค้าทองคำ แล้วค่อย fallback ไป API ราคาทองไทยเดิม หากต้องการใช้ endpoint เฉพาะให้ตั้ง `GOLD_PRICE_API_URL` ใน `.env.local`
