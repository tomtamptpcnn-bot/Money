...
ราคาที่ดึงคือราคาขายทองคำแท่งจากสมาคมค้าทองคำ โดยนับเป็นราคาต่อ 1 บาททองคำ หากสมาคมค้าทองคำใช้ไม่ได้ แอพจะลอง fallback ไป API ราคาทองไทยเดิม หากต้องการใช้ endpoint เฉพาะให้ตั้ง `GOLD_PRICE_API_URL` ใน `.env.local`
